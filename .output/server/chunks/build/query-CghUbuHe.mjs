...
import { b as useNuxtApp, d as asyncDataDefaults, a as useRuntimeConfig, c as createError } from './server.mjs';
import { w as withLeadingSlash, j as joinURL, r as withoutTrailingSlash, I as withBase } from '../nitro/nitro.mjs';
import { h as hash } from '../_/index.mjs';
import { a as useRequestEvent, u as useContentPreview } from './preview-CUm_9g-g.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-BH6U5xjk.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-CghUbuHe.mjs.map
