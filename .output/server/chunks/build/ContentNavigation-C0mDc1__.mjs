...
import { defineComponent, useSlots, toRefs, computed, toRef, isRef, h, useSSRContext } from 'vue';
import { h as hash } from '../_/index.mjs';
import { a as useContentDisabled, u as useAsyncData, q as queryContent, w as withContentBase, e as encodeQueryParams, b as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-CghUbuHe.mjs';
import { u as useContentPreview } from './preview-CUm_9g-g.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-BH6U5xjk.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-C0mDc1__.mjs.map
